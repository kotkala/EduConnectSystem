...
import FullPageChatbot from '@/shared/components/parent-chatbot/full-page-chatbot'
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-blue-50/30">
      <div className="p-4 sm:p-6 lg:p-8 max-w-7xl mx-auto">
        <div className="space-y-8">
          ...
          {/* Chatbot Content */}
          <div className="bg-white/80 backdrop-blur-sm rounded-2xl border border-white/20 shadow-lg shadow-blue-500/5 overflow-hidden">
            <FullPageChatbot />
          </div>
        </div>
      </div>
