...
export default function WeeklyReport() {
  ...
  // Khi currentSemester thay Ä‘á»•i, chồ‰ set tuần hiá»‡n táº¡i một láº§n
  useEffect(() => {
  ...
  const loadWeeklyData = async () => {
    ...
    try {
      ...
      if (result.success && result.data) {
        // Filter null values vÃ  sáº¯p xáº¿p theo sá»‘ vi phạm giảm dáº§n, rá»“i theo Ä‘iá»ƒm giảm dáº§n
    ...
    if (weeklyData.length === 0) {
      return (
        <div className="text-center text-muted-foreground py-8">
          Không có dữ liệu vi phạm cho tuần nÃ y
        </div>
      )
    }
    ...
    <div className="space-y-6">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Xem vi phạm Ä‘Æ°á»£c gá»™p theo hồc sinh trong từng tuần hồc
          </CardDescription>
        </CardHeader>
        <CardContent>
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
            ...
            <div className="space-y-2">
              <label htmlFor="block-select" className="text-sm font-medium">Khồ‘i lớp</label>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Má»—i hồc sinh lÃ  một item gá»“m táº¥t cả vi phạm trong tuần
          </CardDescription>
        </CardHeader>
        <CardContent>
          {renderContent()}
