...
const platformItems: Record<string, PlatformItem[]> = {
  admin: [
    ...
    // User Management
    { title: "Quản lý ngÆ°á»i dùng", url: "/dashboard/admin/users", icon: Users },

    // Academic Structure
    { title: "Năm hồc", url: "/dashboard/admin/academic-years", icon: Calendar },
    { title: "Lớp hồc", url: "/dashboard/admin/classes", icon: GraduationCap },
    { title: "Môn hồc", url: "/dashboard/admin/subjects", icon: BookOpen },
    { title: "Phòng hồc", url: "/dashboard/admin/classrooms", icon: Building },

    // Schedule & Timetable
    { title: "Thồi khóa biểu", url: "/dashboard/admin/timetable", icon: Clock },
    { title: "Yêu cầu Ä‘á»•i lịch", url: "/dashboard/admin/exchange-requests", icon: ArrowLeftRight },

    // Academic Performance
    { title: "Kỳ báo cáo Ä‘iá»ƒm", url: "/dashboard/admin/grade-periods", icon: Calculator },
    { title: "Theo dõi Ä‘iá»ƒm sá»‘", url: "/dashboard/admin/grade-tracking", icon: BarChart3 },
    { title: "Báo cáo hồc tập", url: "/dashboard/admin/report-periods", icon: FileBarChart },
    { title: "Cải thiện Ä‘iá»ƒm sá»‘", url: "/dashboard/admin/grade-improvement", icon: TrendingUp },

    // Student Management
    { title: "Vi phạm hồc sinh", url: "/dashboard/admin/violations", icon: AlertTriangle },
  ],
  ...
  teacher: [
    ...
    { title: "Nhập Ä‘iá»ƒm sá»‘", url: "/dashboard/teacher/grade-management", icon: Calculator },
    { title: "Bảng Ä‘iá»ƒm", url: "/dashboard/teacher/grade-reports", icon: ClipboardList },
    { title: "Báo cáo hồc tập", url: "/dashboard/teacher/reports", icon: BookCheck },
    { title: "Hồp phụ huynh", url: "/dashboard/teacher/meetings", icon: Users },
    { title: "Hồc sinh chủ nhiệm", url: "/dashboard/teacher/homeroom-students", icon: Heart },
    { title: "Äiá»ƒm lớp chủ nhiệm", url: "/dashboard/teacher/homeroom-grades", icon: Award },
    { title: "ÄÆ¡n xin nghỉ", url: "/dashboard/teacher/leave-requests", icon: FileText },
  ],
  student: [
    { title: "Tổng quan", url: "/student", icon: Home },
    { title: "Thông báo", url: "/student/notifications", icon: Bell },
    { title: "Khóa hồc", url: "/student/courses", icon: BookOpen },
    { title: "BÃ i tập", url: "/student/assignments", icon: FileText },
    { title: "Äiá»ƒm sá»‘", url: "/student/grades", icon: Award },
    { title: "Thồi khóa biểu", url: "/student/timetable", icon: Calendar },
    { title: "Cải thiện Ä‘iá»ƒm", url: "/student/grade-improvement", icon: TrendingUp },
  ],
  parent: [
    ...
    { title: "Bảng Ä‘iá»ƒm con em", url: "/dashboard/parent/grades", icon: Award },
    { title: "Báo cáo hồc tập", url: "/dashboard/parent/reports", icon: BookCheck },
    { title: "Phản hồ“i hồc tập", url: "/dashboard/parent/feedback", icon: BarChart3 },
    { title: "Vi phạm con em", url: "/dashboard/parent/violations", icon: AlertTriangle },
    { title: "Lịch hồp", url: "/dashboard/parent/meetings", icon: Calendar },
    { title: "ÄÆ¡n xin nghỉ", url: "/dashboard/parent/leave-application", icon: FileText },
...
export function AppSidebar({ role }: AppSidebarProps) {
  ...
  const items: PlatformItem[] = role === 'teacher'
    ? [
        ...
        { title: "Phản Hồ“i Hồc Sinh", url: "/dashboard/teacher/feedback", icon: BarChart3 },
        { title: "Vi Phạm Hồc Sinh", url: "/dashboard/teacher/violations", icon: AlertTriangle },
            ...
            <DropdownMenu>
              ...
              >
                ...
                >
                  ...
                  <span className="font-medium">ÄÄƒng xuất</span>
                </DropdownMenuItem>
              </DropdownMenuContent>
            </DropdownMenu>
          </SidebarMenuItem>
