...
export default function ParentDashboard() {
  ...
  const loadAllStudents = useCallback(async () => {
    ...
    if (result.success && result.data) {
      ...
      setError(result.error || 'Không th? t?i danh sách h?c sinh')
    }
    setIsLoading(false)
  }, [])
    ...
    return (
      <div className="p-6">
        <div className="flex flex-col items-center justify-center h-64 space-y-4">
          ...
          <p className="text-gray-600">B?n không có quy?n truy c?p trang này.</p>
        ...
        <div className="space-y-3">
          <div className="flex flex-col lg:flex-row items-start lg:items-center justify-between gap-6">
            <div className="space-y-3">
              ...
              <p className="text-muted-foreground max-w-2xl leading-relaxed">
                Qu?n lý ho?t d?ng h?c t?p c?a con em và luôn d?ng hành cùng các em trong hành trình phát tri?n.
              </p>
            </div>
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4">
              ...
              <Select value={selectedYear} onValueChange={setSelectedYear}>
                <SelectTrigger className="w-full sm:w-[240px] bg-white border-gray-200 rounded-lg shadow-sm hover:border-blue-300 transition-colors">
                  <SelectValue placeholder="Ch?n niên khóa" />
                </SelectTrigger>
                <SelectContent className="rounded-lg border-gray-200">
                  <SelectItem value="all" className="rounded-md">T?t c? niên khóa</SelectItem>
          ...
          <div className="grid gap-6 grid-cols-1 sm:grid-cols-2 lg:grid-cols-3">
              ...
              <div className="flex items-center justify-between mb-4">
                ...
                <div className="text-right">
                  ...
                  <p className="text-sm text-blue-600 font-medium">
                    {selectedYear && selectedYear !== 'all' ? 'Trong niên khóa' : 'T?ng s? con em'}
                  </p>
                </div>
              </div>
              <h3 className="font-semibold text-gray-800">Con em c?a tôi</h3>
            </div>
            ...
            <div className="bg-orange-gradient-soft rounded-2xl p-6 border border-purple-200/50 shadow-lg shadow-purple-500/10">
              ...
              <h3 className="font-semibold text-gray-800">Niên khóa h?c</h3>
            </div>
          </div>
          ...
          <div className="bg-white/80 backdrop-blur-sm rounded-2xl border border-white/20 shadow-lg shadow-blue-500/5">
            <div className="p-6 sm:p-8 border-b border-gray-100">
              <div className="flex items-center gap-3 mb-2">
                ...
                <h2 className="text-2xl font-bold text-gray-900">Con em c?a tôi</h2>
              </div>
              <p className="text-gray-600">
                {selectedYear && selectedYear !== 'all'
                  ? `H?c sinh trong ${academicYears.find(y => y.id === selectedYear)?.name || 'niên khóa dã ch?n'}`
                  : 'T?t c? con em qua các niên khóa h?c'
                }
              </p>
            </div>
          ...
          <div className="space-y-2">
            ...
            <Skeleton className="h-4 w-[150px] mx-auto"  aria-label="Loading content" role="status" />
                      ...
                      <p className="text-gray-600 font-medium">Ðang t?i thông tin h?c sinh...</p>
                    </div>
                  )
                }
                ...
                if (students.length === 0) {
                  const noChildrenMessage = selectedYear && selectedYear !== 'all'
                    ? 'Không có con em nào trong niên khóa dã ch?n'
                    : 'Chua có con em nào du?c dang ký'
                  ...
                  return (
                    <div className="flex flex-col items-center justify-center py-16">
                      ...
                      <h3 className="text-lg font-semibold text-gray-700 mb-2">Không tìm th?y h?c sinh</h3>
                        ...
                        <div className="flex items-start gap-4">
                          ...
                          <div className="flex-1 min-w-0">
                            ...
                            <p className="text-sm text-gray-600 mb-3">
                              Mã h?c sinh: <span className="font-mono font-medium">{student.student_id}</span>
                            </p>
