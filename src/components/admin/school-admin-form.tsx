...
export interface SchoolAdminFormValues {
  phone: string
  full_name: string
  gender?: string
...
interface SchoolAdminFormProps {
  onSubmit: (values: SchoolAdminFormValues) => void
  onCancel: () => void
  loading?: boolean
}

export function SchoolAdminForm({ onSubmit, onCancel, loading }: SchoolAdminFormProps) {
  const [form, setForm] = useState<SchoolAdminFormValues>({
    phone: '',
    full_name: '',
    gender: '',
    date_of_birth: '',
