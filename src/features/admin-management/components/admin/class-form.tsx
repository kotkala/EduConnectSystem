  ...
  return (
    <div className="space-y-4">
      <div className="flex items-center space-x-2">
        ...
        />
        <Label htmlFor="is_subject_combination">Lá»›p chuyÃªn mÃ´n</Label>
      </div>
      ...
      {watchIsSubjectCombination && (
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 pl-6">
          <div className="space-y-2">
            ...
            >
              <SelectTrigger>
                <SelectValue placeholder="Chá»n loáº¡i chuyÃªn mÃ´n" />
              </SelectTrigger>
              <SelectContent>
          ...
          {watchSubjectCombinationType && (
            <div className="space-y-2">
              <Label htmlFor="subject_combination_variant">Biáº¿n thá»ƒ *</Label>
              <Select
              ...
              >
                <SelectTrigger>
                  <SelectValue placeholder="Chá»n biáº¿n thá»ƒ" />
                </SelectTrigger>
                <SelectContent>
      ...
      <div className="grid gap-6">
        ...
        <div className="space-y-2">
          ...
          <Input
            id="name"
            {...form.register("name")}
            placeholder={watchAutoGeneratedName ? "Will be auto-generated" : "Enter class name (e.g., 10A1, LÃ½-HÃ³a-Sinh-01)"}
        ...
        <div className="space-y-2">
          <Label htmlFor="academic_year_display">NÄƒm há»c *</Label>
          <div className="flex items-center gap-2 p-3 border rounded-md bg-muted/50">
            <span className="text-sm font-medium">
              {selectedAcademicYear?.name || 'ChÆ°a chá»n nÄƒm há»c'}
            </span>
          ...
          <p className="text-xs text-muted-foreground">
            NÄƒm há»c Ä‘Æ°á»£c chá»n tá»« dropdown á»Ÿ gÃ³c pháº£i trÃªn cÃ¹ng
          </p>
        </div>

        {/* Semester */}
        <div className="space-y-2">
          <Label htmlFor="semester_id">Há»c ká»³ *</Label>
          <Select
            ...
            <SelectContent>
              {semesters.map((semester) => (
                <SelectItem key={semester.id} value={semester.id}>
                  {semester.name} ({semester.weeks_count} tuáº§n) {semester.is_current && "(Hiá»‡n táº¡i)"}
                </SelectItem>
              ))}
            </SelectContent>
          </Select>
          ...
          >
            {isSubmitting ? (
              ...
              <>
                ...
                {isEditing ? "Cáº­p nháº­t lá»›p" : "Táº¡o lá»›p"}
              </>
            )}
          </Button>
          <Button
