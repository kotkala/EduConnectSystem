          ...
          <TableRow key={violation.id}>
            ...
            <TableCell>
              <div className="flex items-center gap-1 text-sm">
                ...
                {violation.recorded_by_user?.full_name || 'Không xác Ä‘á»‹nh'}
              </div>
            </TableCell>
            <TableCell>
              <Button
    ...
    <div className="space-y-4">
        ...
        <CardContent>
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
            <div className="relative">
              ...
              <Input
                placeholder="Tìm kiếm theo tên hoặc mÃ£ hồc sinh..."
                value={searchTerm}
            ...
            <Select value={severityFilter} onValueChange={setSeverityFilter}>
              <SelectTrigger>
                <SelectValue placeholder="Tất cả mức Ä‘á»™" />
              </SelectTrigger>
              <SelectContent>
          ...
          <div className="flex justify-between items-center mt-4">
            <div className="text-sm text-muted-foreground">
              Äang hiá»ƒn thồ‹ {violations.length}/{total} vi phạm
            </div>
          </div>
        </CardContent>
      </Card>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Danh sách vi phạm hồc sinh Ä‘Ã£ ghi nhận
          </CardDescription>
        </CardHeader>
        <CardContent>
