...
export default function TeacherTimetableCalendar() {
  ...
  const handleCellClick = useCallback(() => {
    ...
    toast.info("Chồ‰ quản trị viên mới có thể tạo lịch giảng dạy mới");
  }, []);
    ...
    <div className="flex flex-1 flex-col gap-4">
      ...
      <div className="flex-1">
        <CalendarDndProvider onEventUpdate={() => {
          ...
          toast.info("Chồ‰ quản trị viên mới có thể chồ‰nh sửa lịch giảng dạy");
        }}>
          <div className="flex-1 rounded-lg border bg-card">
            <div className="flex flex-col h-full">
              {/* Calendar Header */}
              <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between p-3 sm:p-4 border-b">
                <h2 className="text-base sm:text-lg font-semibold">Lịch Giảng Dáº¡y Cá»§a TÃ´i</h2>
