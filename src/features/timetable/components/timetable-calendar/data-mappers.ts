import { CalendarEvent, EventColor } from "@/features/timetable/components/event-calendar/types";
import { TimetableEventDetailed } from "@/features/timetable/actions/timetable-actions";
