...
export async function sendDailyFeedbackToParentsAction(
  ...
  try {
    ...
    if (!profile || profile.role !== 'teacher') {
      return {
        success: false,
        error: "YÃªu cáº§u quyá»n giÃ¡o viÃªn"
      }
    }
    ...
    if (!dailyFeedback || dailyFeedback.length === 0) {
      return {
        success: false,
        error: "KhÃ´ng cÃ³ pháº£n há»“i nÃ o trong ngÃ y nÃ y"
      }
    }
    ...
    if (!parents || parents.length === 0) {
      return {
        success: false,
        error: "KhÃ´ng tÃ¬m tháº¥y phá»¥ huynh cho há»c sinh nÃ y"
      }
    }
    ...
    return {
      success: true,
      message: `ÄÃ£ gá»­i toÃ n bá»™ pháº£n há»“i trong ngÃ y (${dailyFeedback.length} má»¥c) Ä‘áº¿n ${parents.length} phá»¥ huynh thÃ nh cÃ´ng`
    }
    ...
    return {
      success: false,
      error: error instanceof Error ? error.message : "KhÃ´ng thá»ƒ gá»­i pháº£n há»“i trong ngÃ y cho phá»¥ huynh"
    }
  }
}
...
export async function sendFeedbackToParentsAction(
  ...
  try {
    ...
    if (!feedback) {
      return {
        success: false,
        error: "KhÃ´ng tÃ¬m tháº¥y pháº£n há»“i hoáº·c bá»‹ tá»« chá»‘i truy cáº­p"
      }
    }
    ...
    return {
      success: true,
      message: `ÄÃ£ gá»­i pháº£n há»“i thÃ nh cÃ´ng Ä‘áº¿n ${parents.length} phá»¥ huynh`
    }
    ...
    return {
      success: false,
      error: error instanceof Error ? error.message : "KhÃ´ng thá»ƒ gá»­i pháº£n há»“i cho phá»¥ huynh"
    }
  }
}
...
export async function checkDailyFeedbackSentStatusAction(
  ...
  try {
    ...
    return {
      success: false,
      error: error instanceof Error ? error.message : "KhÃ´ng thá»ƒ kiá»ƒm tra tráº¡ng thÃ¡i pháº£n há»“i trong ngÃ y"
    }
  }
}
...
export async function checkFeedbackSentStatusAction(
  ...
  try {
    ...
    return {
      success: false,
      error: error instanceof Error ? error.message : "KhÃ´ng thá»ƒ kiá»ƒm tra tráº¡ng thÃ¡i pháº£n há»“i"
    }
  }
}
