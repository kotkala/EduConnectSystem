...
export async function getTeacherHomeroomClassesAction(): Promise<{
  ...
  try {
    ...
    return {
      success: false,
      error: error instanceof Error ? error.message : "KhÃ´ng thá»ƒ láº¥y danh sÃ¡ch lá»›p chá»§ nhiá»‡m"
    }
  }
}
...
export async function getHomeroomStudentsWithParentsAction(classId: string): Promise<{
  ...
  try {
    ...
    if (!classInfo || classInfo.homeroom_teacher_id !== user.id) {
      throw new Error("Tá»« chá»‘i truy cáº­p. Báº¡n khÃ´ng pháº£i lÃ  giÃ¡o viÃªn chá»§ nhiá»‡m cá»§a lá»›p nÃ y.")
    }
    ...
    return {
      success: false,
      error: error instanceof Error ? error.message : "KhÃ´ng thá»ƒ láº¥y danh sÃ¡ch há»c sinh vÃ  phá»¥ huynh"
    }
  }
}
...
export async function createMeetingScheduleAction(request: CreateMeetingScheduleRequest): Promise<{
  ...
  try {
    ...
    if (meetingError || !meetingSchedule) {
      throw new Error(meetingError?.message || "KhÃ´ng thá»ƒ táº¡o lá»‹ch háº¹n")
    }
    ...
    return {
      success: false,
      error: error instanceof Error ? error.message : "KhÃ´ng thá»ƒ táº¡o lá»‹ch háº¹n"
    }
  }
}
...
export async function getParentMeetingSchedulesAction(): Promise<{
  ...
  try {
    ...
    if (!profile || profile.role !== 'parent') {
      throw new Error("Tá»« chá»‘i truy cáº­p. YÃªu cáº§u vai trÃ² phá»¥ huynh.")
    }
    ...
    return {
      success: false,
      error: error instanceof Error ? error.message : "KhÃ´ng thá»ƒ láº¥y danh sÃ¡ch lá»‹ch háº¹n"
    }
  }
}
...
export async function getUnreadMeetingScheduleCountAction(): Promise<{
  ...
  try {
    ...
    return {
      success: false,
      error: error instanceof Error ? error.message : "KhÃ´ng thá»ƒ láº¥y sá»‘ lÆ°á»£ng chÆ°a Ä‘á»c"
    }
  }
}
