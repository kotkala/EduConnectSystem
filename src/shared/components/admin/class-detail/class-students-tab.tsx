...
import StudentAssignmentForm from "@/shared/components/admin/student-assignment-form"
...
export default function ClassStudentsTab({ classId, classData }: ClassStudentsTabProps) {
  ...
  useEffect(() => {
    const fetchStudents = async () => {
      try {
        ...
        const { getClassStudentsWithDetailsAction } = await import("@/lib/actions/class-actions")
  ...
  const handleRemoveStudent = async (studentId: string) => {
    try {
      ...
      // Import the action dynamically to avoid circular imports
      const { removeStudentFromClassAction } = await import("@/lib/actions/class-actions")
