...
export function AcademicFilters<T extends BaseAcademicFilters>({
  ...
  maxWeeks = 52,
  statusMessage = {
    ready: "âœ“ Sẵn sÃ ng xem dữ liệu",
    instruction: "Vui lòng chồn năm hồc, hồc kỳ vÃ  tuần Ä‘á»ƒ xem dữ liệu"
  }
    ...
    <Card>
      ...
      <CardContent className="space-y-4">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          ...
          {/* Semester Selection */}
          <div className="space-y-2">
            <label htmlFor="semester-select" className="text-sm font-medium">Hồc Kỳ</label>
            <Select
