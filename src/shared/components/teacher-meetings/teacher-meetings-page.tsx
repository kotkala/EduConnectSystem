...
import { HomeroomMeetingDialog } from '@/shared/components/teacher-timetable/homeroom-meeting-dialog'
        ...
        <CardContent className="space-y-4">
          <div className="grid gap-4 md:grid-cols-2">
            ...
            <div className="space-y-2">
              ...
              <ul className="text-sm text-muted-foreground space-y-1">
                <li>• Chỉ giáo viên chủ nhiệm mới có thể gửi lịch họp</li>
                <li>• Thông báo sẽ được gửi đến tất cả phụ huynh của học sinh đã chọn</li>
                <li>• Phụ huynh sẽ nhận được thông báo trong mục &quot;Lịch Họp&quot;</li>
                <li>• Có thể chọn nhiều học sinh cùng lúc để gửi thông báo hàng loạt</li>
              </ul>
            </div>
          </div>
        </CardContent>
