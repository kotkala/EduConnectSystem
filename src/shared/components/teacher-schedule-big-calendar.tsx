...
const EventCalendar = dynamic(() => import("@/shared/components/calendar").then(mod => ({ default: mod.EventCalendar })), {
  ssr: false,
  loading: () => (
...
const ExchangeRequestForm = dynamic(() => import("@/shared/components/schedule-exchange/exchange-request-form").then(mod => ({ default: mod.ExchangeRequestForm })), {
  ssr: false,
  loading: () => <LoadingFallback size="xs" />
});

const ExchangeRequestsList = dynamic(() => import("@/shared/components/schedule-exchange/exchange-requests-list").then(mod => ({ default: mod.ExchangeRequestsList })), {
  ssr: false,
